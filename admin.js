...
async function ensureAdmin() {
  ...
  if (!db) {
    msg("⚠️ Hãy cấu hình Supabase trong admin.js.");
    return false;
  }
  ...
  if (p?.role !== "admin") {
    ...
    msg("Tài khoản này không có quyền admin.");
  ...
  $("#adminUser").textContent =
    `Đang đăng nhập: ${p.full_name || user.email}`;
...
$("#adminJourneyList")
  .addEventListener(
    ...
    e => {
      ...
      if (
        e.target.dataset.journeyDelete
      ) {
...
$("#adminActivityList")
  .addEventListener(
    ...
    e => {
      ...
      if (
        e.target.dataset.activityDelete
      ) {
